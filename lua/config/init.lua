...
local main_menu = {
  width      = helper.validateMax(vim.g.vim_vault_menu_width, 70) or 70,
  ...
  display    = helper.validateBoolean(vim.g.vim_vault_menu_display) or 0,
}
local files_menu = {
  ...
  display    = helper.validateBoolean(vim.g.vim_vault_files_display) or 0,
}
local notes = {
